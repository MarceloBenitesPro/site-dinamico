...
<div class="box-content">
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <textarea name="conteudo" class="tinymce" style="margin-top: 8px; font-size: 16px; font-weight: normal; color: black; width: 100%; height:150px; border: 1px solid #ccc; padding-left: 8px; resize: vertical;" ><?php echo $slide['conteudo']; ?></textarea>
    </div><!--form-group-->
