<div class="box-content">
	<h2><i class="fa-solid fa-book"></i> Cadastrar Imagem Autor</h2>
              ...
              //Podemos cadastrar!
               if(Painel::imagemValida($imagem) == false){
                ...
                // include('../classes/lib/WideImage.php');
                 ...
                 $arr = ['nome'=>$nome,'img_autor'=>$imagem,'order_id'=>'0','nome_tabela'=>'tb_site.img_autor'];
                 Painel::insert($arr);
                 Painel::alert('sucesso', 'O cadastro da imagem do autor foi realizado com sucesso!');
               }
             }      
		   }
		?>
