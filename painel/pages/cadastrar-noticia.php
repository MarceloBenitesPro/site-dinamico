<div class="box-content">
	<h2><i class="fa-solid fa-book"></i> Cadastrar Notícia</h2>
		   ...
		   if(isset($_POST['acao'])){
             //Enviei o meu formulario
               ...
               if($titulo == '' || $conteudo == ''){
                ...
                Painel::alert('erro','A imagem da capa precisa ser selecionada');
                ...
                if(Painel::imagemValida($capa)){
                   ...
                   if($verifica->rowCount() == 0){
                    ...
                    'order_id'=>'0','nome_tabela'=>'tb_site.noticias'];
    ...
    <div class="form-group">
      ...
      <textarea name="conteudo" class="tinymce" style="margin-top: 8px; font-size: 16px; font-weight: normal; color: black; width: 100%; height:150px; border: 1px solid #ccc; padding-left: 8px; resize: vertical;" ><?php recoverPost('conteudo'); ?></textarea>
    </div><!--form-group-->
